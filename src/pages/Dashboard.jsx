...
// Imports at top (need to add Recharts)
            ...
            <div className="p-6 max-w-7xl mx-auto space-y-8">
                ...
                {/* Stats Grid - Kept same, backend handles logic */}
                {stats && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {/* ... Cards ... */}
                        {/* Modify the last card logic or add a new row for charts */}
                    </div>
                )}
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            <div className="h-64">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={[
                                        { name: 'In Progress', value: stats.issues.inProgress },
                                        { name: 'Working', value: stats.issues.working || 0 }, // Backend might return working
